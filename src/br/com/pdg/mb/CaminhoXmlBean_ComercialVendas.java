...
@ManagedBean(name="camXmlBean_ComVen")
@ViewScoped
public class CaminhoXmlBean_ComercialVendas implements Serializable {
	...
	private List<CaminhoXml> cXmls;
		...
		//para o caminho xml do getComercialVendas o id deve ser sempre 3
		public String buscaPorId(){
			DAO<CaminhoXml> dao = new DAO<CaminhoXml>(CaminhoXml.class);
			CaminhoXml cx = dao.buscaPorId((long) 3);
