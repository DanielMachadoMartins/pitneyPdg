...
@ManagedBean(name="camXmlBean_Comp")
@ViewScoped
public class CaminhoXmlBean_Compradores implements Serializable {
	...
	private List<CaminhoXml> cXmls;
		...
		//para o caminho xml do getCompradores o id deve ser sempre 5
		public String buscaPorId(){
			DAO<CaminhoXml> dao = new DAO<CaminhoXml>(CaminhoXml.class);
			CaminhoXml cx = dao.buscaPorId((long) 5);
