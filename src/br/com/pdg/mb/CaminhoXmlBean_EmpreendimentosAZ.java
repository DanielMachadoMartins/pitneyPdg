...
@ManagedBean(name="camXmlBean_EmpAZ")
@ViewScoped
public class CaminhoXmlBean_EmpreendimentosAZ implements Serializable {
	...
	private List<CaminhoXml> cXmls;
		...
		//para o caminho xml do getEmpreendimentosAZ o id deve ser sempre 6
		public String buscaPorId(){
			DAO<CaminhoXml> dao = new DAO<CaminhoXml>(CaminhoXml.class);
			CaminhoXml cx = dao.buscaPorId((long) 6);
